...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 bg-slate-900 border-r border-white/5 flex flex-col h-screen fixed left-0 top-0 z-50">
            {/* Header */}
            ...
            <div className="p-4 border-t border-white/5 bg-slate-950/30">
                <a href={`${process.env.NEXT_PUBLIC_PORTAL_URL || 'http://localhost:3000'}/`} className="flex items-center gap-3 mb-4 text-slate-400 hover:text-white transition-colors">
