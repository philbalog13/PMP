            ...
            case 'failed':
                return (
                    <span className="px-2 py-1 bg-red-500/20 text-red-400 text-xs rounded-full flex items-center gap-1">
                        <XCircle size={12} /> Échouée
                    </span>
                );
            case 'refunded':
                return (
                    <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs rounded-full flex items-center gap-1">
                        <ArrowDownLeft size={12} /> Remboursée
                    </span>
                );
            default:
                return null;
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    <div className="bg-slate-800/50 border border-white/10 rounded-xl p-4">
                        <p className="text-sm text-slate-400 mb-1">Total débits</p>
                        <p className="text-2xl font-bold text-white">
                            -{totalDebits.toLocaleString('fr-FR', { minimumFractionDigits: 2 })} EUR
                        </p>
                    </div>
                    <div className="bg-slate-800/50 border border-white/10 rounded-xl p-4">
                        <p className="text-sm text-slate-400 mb-1">Total crédits</p>
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                    <div className="relative flex-1">
                        ...
                        <input
                            type="text"
                            placeholder="Rechercher un marchand ou une catégorie..."
                            value={searchTerm}
                        ...
                        >
                            ...
                            <div className="md:col-span-4 flex items-center gap-3">
                                <div className={`p-3 rounded-xl ${
                                    tx.type === 'credit' ? 'bg-emerald-500/20' : 'bg-slate-700'
                                }`}>
                                    {tx.type === 'credit' ? (
