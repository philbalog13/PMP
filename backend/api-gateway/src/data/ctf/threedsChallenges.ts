...
export const THREEDS_CHALLENGES: CtfChallengeSeed[] = [
    {
        ...
        hints: [
            { hintNumber: 1, hintText: 'Essayez les codes OTP courants : 000000, 123456, 111111...', costPoints: 5 },
            { hintNumber: 2, hintText: 'Le code 123456 fonctionne pour TOUTES les transactions. C est hardcode.', costPoints: 10 },
    ...
    },
    {
        ...
        hints: [
            { hintNumber: 1, hintText: 'Le champ transStatus accepte des valeurs non standard. Testez des mots comme SUCCESS, TEST, DEBUG.', costPoints: 5 },
            { hintNumber: 2, hintText: 'transStatus="SUCCESS" bypass tout le flow sans challenge.', costPoints: 10 },
            { hintNumber: 3, hintText: 'Le flag suit le format PMP{...}. Validez votre exploitation pour le recuperer.', costPoints: 25 },
        ],
    },
    {
