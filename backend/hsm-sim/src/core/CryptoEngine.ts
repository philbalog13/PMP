...
export type MacAlgorithm = 'RETAIL-MAC' | 'CMAC' | 'HMAC-SHA256';
...
export class CryptoEngine {
     ...
     * Sign data with RSA
     */
    async sign(data: Buffer, privateKey: Buffer | string): Promise<Buffer> {
     ...
     */
    private async generateRetailMac(data: Buffer, key: Buffer): Promise<Buffer> {
