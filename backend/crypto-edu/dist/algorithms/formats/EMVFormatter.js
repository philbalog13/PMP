...
exports.EMVFormatter = void 0;
const hex_1 = require("../../utils/hex");
const MACCalculator_1 = require("../mac/MACCalculator");
class EMVFormatter {
    macManager = new MACCalculator_1.MACManager();
    /**
    ...
    generateARQC(data, sessionKey) {
        ...
        const constructHex = (val, lenBytes) => val.padStart(lenBytes * 2, '0');
        const dataHex = constructHex(data.amount, 6) +
        ...
        const inputData = (0, hex_1.hexToBuffer)(dataHex);
        steps.push({
        ...
        const paddedBuffer = (0, hex_1.hexToBuffer)(paddedHex);
        steps.push({
            name: 'Padding (EMV)',
            description: 'Pad with 0x80 ... 0x00 to multiple of 8 bytes',
            input: (0, hex_1.bufferToHex)(inputData),
            output: paddedHex
        });
        // 3. Compute MAC (ALG3)
    ...
    generateARPC(arqc, responseCode, key) {
        const steps = [];
        // ARPC Method 1: ARPC = MAC(ARQC ^ ARC, Key) ... 
        // Common EMV Method 1:
        // ARQC (8 bytes) XOR 000000000000 + ARC (2 bytes)
        const arcBuffer = (0, hex_1.hexToBuffer)(responseCode.padEnd(4, '0'));
        ...
        const xorInput = Buffer.concat([(0, hex_1.hexToBuffer)(responseCode), Buffer.alloc(6, 0)]);
        const xored = (0, hex_1.xorBuffers)(arqc, xorInput);
        steps.push({
            name: 'ARQC XOR ARC',
            description: 'XOR ARQC with Response Code (padded)',
            input: `ARQC: ${(0, hex_1.bufferToHex)(arqc)}\nARC: ${(0, hex_1.bufferToHex)(xorInput)}`,
            output: (0, hex_1.bufferToHex)(xored)
        });
        // 3DES Encrypt
...
exports.EMVFormatter = EMVFormatter;
